...
class TwitterAdmin(admin.ModelAdmin):
    list_display = ('name', 'blacklist', 'whitelist', 'total_tokens','ath','total_trans')
...
class TokenAdmin(admin.ModelAdmin):
    list_display = ('address', 'dev', 'twitter', 'ath', 'total_trans','migrated', 'created_at', 'processed','total_fees')
...
class SettingsAdmin(admin.ModelAdmin):
    list_display = ('buyer_pubkey', 'sol_amount', 'slippage_percent', 'priority_fee_sol',  'start','median')
    list_filter = ('start',)
