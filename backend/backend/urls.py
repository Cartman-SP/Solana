...
urlpatterns = [
    ...
    path('api/auto_buy_settings/', get_auto_buy_settings, name='get_auto_buy_settings'),
    path('api/auto_buy_settings/', update_auto_buy_settings, name='update_auto_buy_settings'),
]
